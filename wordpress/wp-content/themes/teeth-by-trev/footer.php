	...
	<div class="mx-auto max-w-[1600px] px-6 lg:px-12">
		<div class="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
			<div>
				...
				<p class="mt-4 max-w-sm text-xs leading-relaxed text-ivory/55">Teeth by Trev is operated by Trevor Jamal Thomas DDS, Inc., a California professional corporation.</p>
				<address class="mt-6 text-sm not-italic leading-relaxed text-ivory/55">436 N Bedford Dr #300<br>Beverly Hills, CA 90210<br><a href="mailto:dr.trev@teethbytrev.com" class="transition-colors hover:text-gold">dr.trev@teethbytrev.com</a><br><a href="tel:+14246723910" class="transition-colors hover:text-gold">424-672-3910</a></address>
		...
		<div class="mt-12 flex flex-col items-start justify-between gap-3 border-t border-ivory/10 pt-8 text-[0.58rem] uppercase tracking-[0.26em] text-ivory/55 sm:flex-row"><span>© <?php echo esc_html( gmdate( 'Y' ) ); ?> Teeth by Trev. All rights reserved.</span><span>Beverly Hills · New York · Atlanta · Houston · Miami · Washington D.C. · Tampa · Memphis</span></div>
		<div class="mt-6 flex flex-wrap items-center gap-x-8 gap-y-3 text-[0.58rem] uppercase tracking-[0.26em] text-ivory/55"><a href="<?php echo esc_url( home_url( '/privacy/' ) ); ?>" class="transition-colors hover:text-gold">Privacy Policy</a><a href="<?php echo esc_url( home_url( '/terms/' ) ); ?>" class="transition-colors hover:text-gold">Terms &amp; Conditions</a></div>
	</div>
</footer>
<div class="grain" aria-hidden="true"></div>
<?php wp_footer(); ?>
