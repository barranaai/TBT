	...
	<div class="mx-auto max-w-[1600px] px-6 lg:px-12">
		<div class="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
			<div>
				...
				<address class="mt-6 text-sm not-italic leading-relaxed text-ivory/55"><a href="mailto:dr.trev@teethbytrev.com" class="transition-colors hover:text-gold">dr.trev@teethbytrev.com</a><br><a href="tel:+14246723910" class="transition-colors hover:text-gold">424-672-3910</a></address>
		...
		<div class="mt-12 flex flex-col items-start justify-between gap-3 border-t border-ivory/10 pt-8 text-[0.58rem] uppercase tracking-[0.26em] text-ivory/55 sm:flex-row"><span>© <?php echo esc_html( gmdate( 'Y' ) ); ?> Teeth by Trev. All rights reserved.</span><?php echo tbt_location_list(); ?></div>
